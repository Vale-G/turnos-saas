...
export default function CajaElite() {
  ...
  const totalIngresos = useMemo(
    () => ingresos.reduce((acc, t) => acc + (t.servicio?.precio || 0), 0),
    [ingresos]
  )
      ...
      <div className="min-h-screen bg-[#020617] text-white p-6 md:p-12 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg w-full bg-white/5 border border-white/10 p-12 rounded-[3.5rem] text-center backdrop-blur-xl shadow-2xl">
          ...
          <p className="text-slate-400 text-sm font-medium mb-8">
            La Caja y Ganancia Neta es exclusiva del plan PRO Elite.
          </p>
        </div>
      </div>
    )
      ...
      <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h1 className="text-6xl font-black uppercase italic tracking-tighter leading-none">
              Caja <span style={{ color: colorP }}>PRO</span>
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white/5 border border-white/10 p-10 rounded-[3rem] relative overflow-hidden group">
            <div
              ...
              style={{
                backgroundColor: gananciaNeta >= 0 ? colorP : '#f43f5e',
              }}
            />
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-2">
              Ganancia Neta
            ...
            <p
              ...
              style={{ color: gananciaNeta >= 0 ? colorP : '#f43f5e' }}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <form
            ...
            className="bg-white/4 border border-white/5 p-10 rounded-[3.5rem] h-fit shadow-2xl"
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-black/50 border border-white/10 p-5 rounded-2xl text-xs font-black uppercase outline-none focus:border-white/30 transition-all [&::-webkit-calendar-picker-indicator]:invert"
                />
              </div>
              <div>
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2 block">
                ...
                <input
                  ...
                  className="w-full bg-black/50 border border-white/10 p-5 rounded-2xl text-xs font-black uppercase outline-none focus:border-white/30 transition-all placeholder:text-slate-800"
                />
              </div>
              <div>
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2 block">
              ...
              <button
                type="submit"
                disabled={guardando}
                className="w-full mt-4 py-6 rounded-[2.5rem] font-black uppercase italic text-lg text-black transition-all hover:scale-105 active:scale-95 shadow-xl"
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 mb-6 px-4">
              Historial de Gastos
            </p>
            {gastos.length === 0 ? (
              ...
              <div className="space-y-3">
                {gastos.map((g) => (
                  <div
                    key={g.id}
                    className="bg-white/4 border border-white/5 p-6 rounded-[2.5rem] flex justify-between items-center group hover:bg-white/10 transition-all"
                  >
                    <div>
                      <p className="text-lg font-black uppercase italic text-white/90">
                        {g.concepto}
                      </p>
                    ...
                    <div className="text-right flex flex-col items-end">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 text-rose-500 font-black text-[9px] uppercase tracking-widest transition-all bg-rose-500/10 px-3 py-1.5 mt-1 rounded-xl hover:bg-rose-500/20"
                      >
                        Eliminar
                      </button>
                    </div>
