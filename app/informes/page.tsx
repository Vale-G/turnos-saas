      ...
      <div className="max-w-4xl mx-auto">
        ...
        {loading ? <div className="text-center py-20 text-slate-700 font-black italic animate-pulse">Calculando...</div> : (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white/4 border border-white/8 rounded-2xl p-5"><p className="text-[9px] font-black uppercase text-slate-500 mb-2">Cobrado</p><p className="text-2xl font-black text-emerald-400">${totalIngreso.toLocaleString('es-AR')}</p></div>
          </div>
        )}
      </div>
    </div>
