    ...
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <section className="max-w-2xl mx-auto px-6 pb-24">
        <div className="bg-[#0F172A] rounded-[2rem] border border-white/8 p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="ml-auto text-[9px] bg-amber-400 text-black font-black uppercase px-2 py-0.5 rounded-full">PRO</span>
          </div>
            ...
            {[
              ...
              <div key={t.nombre} className="bg-[#1E293B] rounded-xl p-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-slate-500 truncate">{t.servicio}</p>
                </div>
                <div className="text-right flex-shrink-0">
                  <p className="font-black text-sm" style={{ color: t.color }}>{t.hora}</p>
                  <p className="text-[9px] uppercase font-black" style={{ color: t.color }}>{t.estado}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          {FEATURES.map(f => (
            <div key={f.titulo} className="bg-white/4 border border-white/8 rounded-2xl p-5 hover:bg-white/6 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div className="bg-white/4 border border-white/8 rounded-[2rem] overflow-hidden">
            ...
            <div className="p-6 space-y-2.5">
              {['Reservas ilimitadas','2 barberos','5 servicios','Agenda y cobros'].map(f => (
