    ...
    <div className="bg-white/4 border border-white/8 rounded-[2rem] p-6 max-w-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="text-slate-500 hover:text-white text-sm font-black"
          >
            X
          </button>
        )}
      </div>
      <h3 className="font-black italic uppercase text-xl mb-2">
        Desbloqueá todo
      </h3>
      <p className="text-slate-400 text-sm mb-4">
        Upgradeá a Pro y accedé a todas las funciones.
      </p>
